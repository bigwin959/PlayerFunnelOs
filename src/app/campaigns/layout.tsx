...
import { LayoutDashboard, Megaphone, TrendingUp, LogOut } from 'lucide-react'
        ...
        <div style={{ display: 'flex', minHeight: '100vh' }}>
            <aside style={{
                ...
                <nav style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 4 }}>
                    <div style={{ fontSize: 10, fontWeight: 600, color: '#334155', textTransform: 'uppercase', letterSpacing: '0.08em', padding: '0 8px', marginBottom: 6 }}>Navigation</div>
                ...
                <button onClick={handleLogout} className="btn-ghost" style={{ width: '100%', justifyContent: 'flex-start', marginTop: 8 }}>
